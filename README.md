...
- **Imagen Docker**: `ghcr.io/naahiki/zinekide-chatbot:2.0.25` (privada, acceso vía PAT facilitado por DVM).
...
```bash
# Editar .env: CHATBOT_IMAGE=ghcr.io/naahiki/zinekide-chatbot:2.0.25
docker compose pull
docker compose up -d
```
...
# GitHub Actions builda y publica ghcr.io/naahiki/zinekide-chatbot:2.0.25
```
